...
{
	static auto fn = UObject::FindObject<UFunction>("Function DA_PunchPack.DA_PunchPack_C.BPPressSecondaryFire");

	ADA_PunchPack_C_BPPressSecondaryFire_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function DA_PunchPack.DA_PunchPack_C.BPReleaseSecondaryFire");

	ADA_PunchPack_C_BPReleaseSecondaryFire_Params params;
	params.FortDecoHelper = FortDecoHelper;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function DA_PunchPack.DA_PunchPack_C.MinHeldTimeCheck");

	ADA_PunchPack_C_MinHeldTimeCheck_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function DA_PunchPack.DA_PunchPack_C.BPOnUnEquip");

	ADA_PunchPack_C_BPOnUnEquip_Params params;
