...
{
public:
	class UMeshDescription*                            MeshDescription;                                          // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x28];                                      // 0x0030(0x0028) MISSED OFFSET
	TArray<class UEditableMeshAdapter*>                Adapters;                                                 // 0x0058(0x0010) (ZeroConstructor)
	int                                                TextureCoordinateCount;                                   // 0x0068(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xF8];                                      // 0x006C(0x00F8) MISSED OFFSET
	int                                                PendingCompactCounter;                                    // 0x0164(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SubdivisionCount;                                         // 0x0168(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1E4];                                     // 0x016C(0x01E4) MISSED OFFSET
