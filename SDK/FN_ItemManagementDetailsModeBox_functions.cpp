...
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemManagementDetailsModeBox.ItemManagementDetailsModeBox_C.OnInitialized");

	UItemManagementDetailsModeBox_C_OnInitialized_Params params;
