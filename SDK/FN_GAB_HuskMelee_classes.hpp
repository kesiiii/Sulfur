...
public:
	...
	class UFortAbilityTask_MoveAI*                     HuskMove;                                                 // 0x08E8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	class UClass*                                      GE_AIBaseMeleeFrustration_Reset;                          // 0x0900(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
