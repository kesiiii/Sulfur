...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCL_Carmine_Aura.GCL_Carmine_Aura_C.OnLoopingStart");

	AGCL_Carmine_Aura_C_OnLoopingStart_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCL_Carmine_Aura.GCL_Carmine_Aura_C.OnRemoval");

	AGCL_Carmine_Aura_C_OnRemoval_Params params;
	params.MyTarget = MyTarget;
	params.Parameters = Parameters;
	params.ParticleComponents = ParticleComponents;
	params.AudioComponents = AudioComponents;
