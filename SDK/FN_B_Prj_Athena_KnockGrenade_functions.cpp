...
{
	static auto fn = UObject::FindObject<UFunction>("Function B_Prj_Athena_KnockGrenade.B_Prj_Athena_KnockGrenade_C.LaunchDeimos");

	AB_Prj_Athena_KnockGrenade_C_LaunchDeimos_Params params;
