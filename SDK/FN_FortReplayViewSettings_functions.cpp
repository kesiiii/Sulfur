...
void UFortReplayViewSettings_C::CameraTypeToText(ESpectatorCameraType CameraType, struct FText* Text)
{
	static auto fn = UObject::FindObject<UFunction>("Function FortReplayViewSettings.FortReplayViewSettings_C.CameraTypeToText");

	UFortReplayViewSettings_C_CameraTypeToText_Params params;
