...
public:
	...
	float                                              DebugZoomTL_CameraRotLevelMax_41B63CEF445574B1F9D6F489004E4238;// 0x0898(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DebugZoomTL_CameraRotLevelZero_41B63CEF445574B1F9D6F489004E4238;// 0x089C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DebugZoomTL_CameraOffsetX___LevelMax_41B63CEF445574B1F9D6F489004E4238;// 0x08A0(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DebugZoomTL_CameraOffsetX___LevelZero_41B63CEF445574B1F9D6F489004E4238;// 0x08A4(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DebugZoomTL_TotalNumberOfZoomLevels_41B63CEF445574B1F9D6F489004E4238;// 0x08A8(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DebugZoomTL_CameraHeight_LevelMax_41B63CEF445574B1F9D6F489004E4238;// 0x08AC(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DebugZoomTL_CameraHeight_LevelZero_41B63CEF445574B1F9D6F489004E4238;// 0x08B0(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DebugZoomTL_FOV_In_41B63CEF445574B1F9D6F489004E4238;      // 0x08B4(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DebugZoomTL_FOV_Out_41B63CEF445574B1F9D6F489004E4238;     // 0x08B8(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    DebugZoomTL__Direction_41B63CEF445574B1F9D6F489004E4238;  // 0x08BC(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	struct FVector                                     FocusedTileLocWithOffset;                                 // 0x08F0(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	...
	struct FVector                                     ForwardVector;                                            // 0x090C(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	float                                              CameraYRotationLevelZero;                                 // 0x0918(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     TargetTileLoc;                                            // 0x091C(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	...
	struct FVector                                     HexWorldLocFromBP_Hex_PARENT;                             // 0x09A4(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	...
	struct FVector                                     CenterLocOfAllHexes;                                      // 0x09C4(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	...
	void InpActEvt_MouseScrollUp_K2Node_InputKeyEvent_1_2(const struct FKey& Key);
	void InpActEvt_MouseScrollDown_K2Node_InputKeyEvent_0_1(const struct FKey& Key);
	void OnActivated();
	void OnDeactivated();
