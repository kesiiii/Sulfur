...
// bool                           InHideFill                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UAthenaMatchmakingModeButton_C::SetSquadFillText(bool InFillText, bool InHideFill)
{
