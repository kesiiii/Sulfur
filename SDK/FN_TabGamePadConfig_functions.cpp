...
void UTabGamePadConfig_C::SetupDisplayObject(int InputIndex, class UOptionsMenuInputOneKeyDisplayOnly_C** ReturnObject)
{
	static auto fn = UObject::FindObject<UFunction>("Function TabGamePadConfig.TabGamePadConfig_C.SetupDisplayObject");

	UTabGamePadConfig_C_SetupDisplayObject_Params params;
...
void UTabGamePadConfig_C::DialogResult_78BE0188450C0D75A0C9159AB760C3B8(EFortDialogResult Result, const struct FName& ResultName)
{
	static auto fn = UObject::FindObject<UFunction>("Function TabGamePadConfig.TabGamePadConfig_C.DialogResult_78BE0188450C0D75A0C9159AB760C3B8");

	UTabGamePadConfig_C_DialogResult_78BE0188450C0D75A0C9159AB760C3B8_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function TabGamePadConfig.TabGamePadConfig_C.HandleChangeBinding");

	UTabGamePadConfig_C_HandleChangeBinding_Params params;
	params.NewKey = NewKey;
