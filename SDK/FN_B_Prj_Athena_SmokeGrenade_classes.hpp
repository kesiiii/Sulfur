...
public:
	...
	class UParticleSystem*                             P_SmokeGrenadeExplosion;                                  // 0x0768(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
