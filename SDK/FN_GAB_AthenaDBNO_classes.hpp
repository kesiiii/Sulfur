...
public:
	...
	class UAnimMontage*                                DeathMontageSkydive;                                      // 0x09B8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FActiveGameplayEffectHandle                 DBNOBleedGEHandle;                                        // 0x09C0(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
