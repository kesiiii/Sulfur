...
{
	struct FPoseLink                                   Source;                                                   // 0x0048(0x0010) (Edit)
	class UClass*                                      ControlRigClass;                                          // 0x0058(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UControlRig*                                 ControlRig;                                               // 0x0060(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
};
...
{
	unsigned char                                      UnknownData00[0x1C0];                                     // 0x0800(0x01C0) MISSED OFFSET
};
