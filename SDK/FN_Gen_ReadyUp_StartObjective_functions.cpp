...
void UGen_ReadyUp_StartObjective_C::SetParams(float ReadyUpTimerLength, const struct FText& InteractText, int BluGloMissionActivationQty, bool IsFightTheStorm, TArray<struct FTransform>* InteractSpawnLocation, class UGen_ReadyUp_StartObjective_C** ThisObject)
{
