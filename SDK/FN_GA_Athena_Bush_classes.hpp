...
public:
	...
	class AFortPlayerPawn*                             PlayerPawn;                                               // 0x0938(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	float                                              TriggerDuration;                                          // 0x0940(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0944(0x0004) MISSED OFFSET
	struct FDataTableRowHandle                         UseBushObjectiveStat;                                     // 0x0948(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance)
