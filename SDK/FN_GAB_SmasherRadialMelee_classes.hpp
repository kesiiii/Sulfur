...
public:
	...
	float                                              SmasherRotationRate;                                      // 0x08F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x08F4(0x0004) MISSED OFFSET
	class UFortAbilityTask_MoveAI*                     Move;                                                     // 0x08F8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
