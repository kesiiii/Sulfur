...
{
	static auto fn = UObject::FindObject<UFunction>("Function B_BGA_Athena_C4.B_BGA_Athena_C4_C.OnRep_LandedTime");

	AB_BGA_Athena_C4_C_OnRep_LandedTime_Params params;
