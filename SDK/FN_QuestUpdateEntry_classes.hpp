...
public:
	...
	struct FScriptMulticastDelegate                    AllQuestUpdatesFinished_0_1;                              // 0x0260(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)
