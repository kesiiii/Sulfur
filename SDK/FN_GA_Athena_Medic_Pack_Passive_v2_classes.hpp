...
public:
	...
	class AFortPlayerPawnAthena*                       PlayerPawn;                                               // 0x09A8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	struct FTimerHandle                                TargetTimer;                                              // 0x09B0(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
	class ABP_MedicPack_HealTarget_C*                  TargetIndicator;                                          // 0x09B8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	class ABP_MedicPack_HealNozzle_C*                  TargetingNozzle;                                          // 0x09C0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
