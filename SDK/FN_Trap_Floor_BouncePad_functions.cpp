...
void ATrap_Floor_BouncePad_C::ResetActivation()
{
	static auto fn = UObject::FindObject<UFunction>("Function Trap_Floor_BouncePad.Trap_Floor_BouncePad_C.ResetActivation");

	ATrap_Floor_BouncePad_C_ResetActivation_Params params;
