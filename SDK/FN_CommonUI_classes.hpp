...
public:
	...
	struct FScriptMulticastDelegate                    OnDoubleClicked;                                          // 0x0430(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0x10];                                      // 0x0440(0x0010) MISSED OFFSET
	int                                                MinWidth;                                                 // 0x0450(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MinHeight;                                                // 0x0454(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bButtonEnabled;                                           // 0x0458(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bInteractionEnabled;                                      // 0x0459(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x26];                                      // 0x045A(0x0026) MISSED OFFSET
...
public:
	...
	unsigned char                                      bStopDoubleClickPropagation : 1;                          // 0x0808(0x0001) (Transient)
	unsigned char                                      UnknownData06[0x87];                                      // 0x0809(0x0087) MISSED OFFSET
...
{
public:
	struct FSlateBrush                                 LoadingBackgroundBrush;                                   // 0x01E8(0x0088) (Edit)
	struct FName                                       MaterialTextureParamName;                                 // 0x0270(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    BP_OnLoadingStateChanged;                                 // 0x0278(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	struct FSlateBrush                                 LoadingBackgroundBrush;                                   // 0x0118(0x0088) (Edit)
	TEnumAsByte<EHorizontalAlignment>                  ThrobberAlignment;                                        // 0x01A0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x01A1(0x0003) MISSED OFFSET
	struct FMargin                                     ThrobberPadding;                                          // 0x01A4(0x0010) (Edit, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x01B4(0x0004) MISSED OFFSET
	struct FText                                       LoadingText;                                              // 0x01B8(0x0018) (Edit)
	class UClass*                                      TextStyle;                                                // 0x01D0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    BP_OnLoadingStateChanged;                                 // 0x01D8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FSoftObjectPath                             SpinnerMaterialPath;                                      // 0x01E8(0x0018) (Config)
	unsigned char                                      UnknownData02[0x28];                                      // 0x0200(0x0028) MISSED OFFSET
...
{
public:
	class UMenuAnchor*                                 PopupMenuAnchor;                                          // 0x0890(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UCommonPopupMenu*                            PopupMenu;                                                // 0x0898(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	struct FScriptMulticastDelegate                    OnRotated;                                                // 0x08A0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class UCommonTextBlock*                            MyText;                                                   // 0x08B0(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	TWeakObjectPtr<class UCommonWidgetSwitcher>        LinkedSwitcher;                                           // 0x0264(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x026C(0x0004) MISSED OFFSET
	TMap<struct FName, struct FCommonRegisteredTabInfo> RegisteredTabsByID;                                       // 0x0270(0x0050) (ZeroConstructor, Transient)
	class UCommonButtonGroup*                          TabButtonGroup;                                           // 0x02C0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	class UClass*                                      DefaultTextStyle;                                         // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
	class UClass*                                      DefaultButtonStyle;                                       // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData)
	class UClass*                                      DefaultBorderStyle;                                       // 0x0038(0x0008) (ZeroConstructor, IsPlainOldData)
	class UObject*                                     DefaultImageResourceObject;                               // 0x0040(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FSlateBrush                                 DefaultThrobberBrush;                                     // 0x0048(0x0088)
	TArray<struct FCommonInputKeyDisplayConfiguration> InputKeyToPlatformSpecificDisplayDataMap;                 // 0x00D0(0x0010) (Edit, ZeroConstructor, Config)
	struct FDataTableRowHandle                         DefaultClickAction;                                       // 0x00E0(0x0010) (Edit, Config)
	struct FSoftClassPath                              DefaultTextStyle_StringRef;                               // 0x00F0(0x0018) (Edit, Config)
	struct FSoftClassPath                              DefaultButtonStyle_StringRef;                             // 0x0108(0x0018) (Edit, Config)
	struct FSoftClassPath                              DefaultBorderStyle_StringRef;                             // 0x0120(0x0018) (Edit, Config)
	struct FSoftObjectPath                             DefaultThrobberMaterial_StringRef;                        // 0x0138(0x0018) (Edit, Config)
	struct FSoftObjectPath                             DefaultImageResourceObject_StringRef;                     // 0x0150(0x0018) (Edit, Config)
	class UMaterialInterface*                          DefaultThrobberMaterial;                                  // 0x0168(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class UClass*                                      ButtonWidgetType;                                         // 0x0100(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FMargin                                     ButtonPadding;                                            // 0x0108(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	unsigned char                                      UnknownData00[0x10];                                      // 0x0118(0x0010) MISSED OFFSET
	class UCommonWidgetCarousel*                       LinkedCarousel;                                           // 0x0128(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UCommonButtonGroup*                          ButtonGroup;                                              // 0x0130(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<class UCommonButton*>                       Buttons;                                                  // 0x0138(0x0010) (ExportObject, ZeroConstructor)
