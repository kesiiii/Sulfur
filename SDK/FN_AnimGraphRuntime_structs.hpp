...
struct FAnimNode_AimOffsetLookAt : public FAnimNode_BlendSpacePlayer
{
	...
	struct FVector                                     SocketAxis;                                               // 0x0160(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
...
struct FAnimNode_AnimDynamics : public FAnimNode_SkeletalControlBase
{
	...
	struct FVector                                     ComponentLinearAccScale;                                  // 0x0178(0x000C) (Edit, IsPlainOldData)
	struct FVector                                     ComponentLinearVelScale;                                  // 0x0184(0x000C) (Edit, IsPlainOldData)
	struct FVector                                     ComponentAppliedLinearAccClamp;                           // 0x0190(0x000C) (Edit, IsPlainOldData)
	bool                                               bOverrideLinearDamping;                                   // 0x019C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x019D(0x0003) MISSED OFFSET
	float                                              LinearDampingOverride;                                    // 0x01A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideAngularDamping;                                  // 0x01A4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x01A5(0x0003) MISSED OFFSET
	float                                              AngularDampingOverride;                                   // 0x01A8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideAngularBias;                                     // 0x01AC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x01AD(0x0003) MISSED OFFSET
	float                                              AngularBiasOverride;                                      // 0x01B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDoUpdate;                                                // 0x01B4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bDoEval;                                                  // 0x01B5(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x2];                                       // 0x01B6(0x0002) MISSED OFFSET
	int                                                NumSolverIterationsPreUpdate;                             // 0x01B8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                NumSolverIterationsPostUpdate;                            // 0x01BC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FAnimPhysConstraintSetup                    ConstraintSetup;                                          // 0x01C0(0x005C) (Edit)
	bool                                               bUsePlanarLimit;                                          // 0x021C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x021D(0x0003) MISSED OFFSET
	TArray<struct FAnimPhysPlanarLimit>                PlanarLimits;                                             // 0x0220(0x0010) (Edit, ZeroConstructor)
	bool                                               bUseSphericalLimits;                                      // 0x0230(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x7];                                       // 0x0231(0x0007) MISSED OFFSET
	TArray<struct FAnimPhysSphericalLimit>             SphericalLimits;                                          // 0x0238(0x0010) (Edit, ZeroConstructor)
	EAnimPhysCollisionType                             CollisionType;                                            // 0x0248(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x3];                                       // 0x0249(0x0003) MISSED OFFSET
	float                                              SphereCollisionRadius;                                    // 0x024C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector                                     ExternalForce;                                            // 0x0250(0x000C) (Edit, IsPlainOldData)
	unsigned char                                      UnknownData11[0x134];                                     // 0x025C(0x0134) MISSED OFFSET
};
...
struct FAnimNode_LayeredBoneBlend : public FAnimNode_Base
{
	...
	struct FGuid                                       SkeletonGuid;                                             // 0x0088(0x0010) (IsPlainOldData)
	struct FGuid                                       VirtualBoneGuid;                                          // 0x0098(0x0010) (IsPlainOldData)
...
struct FAnimNode_RotateRootBone : public FAnimNode_Base
{
	...
	struct FRotator                                    MeshToComponent;                                          // 0x00A8(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
...
struct FAnimNode_ScaleChainLength : public FAnimNode_Base
{
	...
	struct FVector                                     TargetLocation;                                           // 0x007C(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
...
struct FAnimNode_Trail : public FAnimNode_SkeletalControlBase
{
	...
	struct FVector                                     FakeVelocity;                                             // 0x01F4(0x000C) (Edit, IsPlainOldData)
	struct FBoneReference                              BaseJoint;                                                // 0x0200(0x0018) (Edit)
	float                                              TrailBoneRotationBlendAlpha;                              // 0x0218(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
