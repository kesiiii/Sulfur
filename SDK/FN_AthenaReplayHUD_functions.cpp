...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaReplayHUD.AthenaReplayHUD_C.SetNameplateLayerDataSource");

	UAthenaReplayHUD_C_SetNameplateLayerDataSource_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaReplayHUD.AthenaReplayHUD_C.SetNameplateLayerVisibility");

	UAthenaReplayHUD_C_SetNameplateLayerVisibility_Params params;
