...
void UButton_Rotate_C::OnTouched_1_2()
{
	static auto fn = UObject::FindObject<UFunction>("Function Button_Rotate.Button_Rotate_C.OnTouched_1_2");

	UButton_Rotate_C_OnTouched_1_2_Params params;
