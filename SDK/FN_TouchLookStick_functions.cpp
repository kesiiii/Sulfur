...
{
	static auto fn = UObject::FindObject<UFunction>("Function TouchLookStick.TouchLookStick_C.Fire Mode Changed");

	UTouchLookStick_C_Fire_Mode_Changed_Params params;
