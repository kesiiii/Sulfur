...
{
	static auto fn = UObject::FindObject<UFunction>("Function B_Prj_Athena_StickyGrenade.B_Prj_Athena_StickyGrenade_C.Event_Building_Actor_Destroyed");

	AB_Prj_Athena_StickyGrenade_C_Event_Building_Actor_Destroyed_Params params;
