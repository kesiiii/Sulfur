...
public:
	...
	struct FText                                       AddFriendText;                                            // 0x03A0(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       AcceptInviteText;                                         // 0x03B8(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       SentInviteText;                                           // 0x03D0(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       AcceptedInviteText;                                       // 0x03E8(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
