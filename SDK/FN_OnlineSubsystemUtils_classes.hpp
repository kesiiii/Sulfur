...
public:
	...
	int BeaconState;
	unsigned char                                      UnknownData01[12];                                      // 0x0340(0x0010) MISSED OFFSET
...
{
public:
	unsigned char                                      LogPortUnreach : 1;                                       // 0x0680(0x0001) (Config)
	unsigned char                                      AllowPlayerPortUnreach : 1;                               // 0x0680(0x0001) (Config)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0681(0x0003) MISSED OFFSET
	uint32_t                                           MaxPortCountToTry;                                        // 0x0684(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x18];                                      // 0x0688(0x0018) MISSED OFFSET
	uint32_t                                           ServerDesiredSocketReceiveBufferBytes;                    // 0x06A0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ServerDesiredSocketSendBufferBytes;                       // 0x06A4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketReceiveBufferBytes;                    // 0x06A8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketSendBufferBytes;                       // 0x06AC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
