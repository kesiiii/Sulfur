...
public:
	...
	class UFortWorldItemDefinition*                    C4ItemDef;                                                // 0x08D8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FGameplayTag                                TrackedActorTag;                                          // 0x08E0(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
	float                                              DelayBetweenExplosions;                                   // 0x08E8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              CurrentExplosionDelay;                                    // 0x08EC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
