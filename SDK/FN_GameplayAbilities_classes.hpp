...
public:
	...
	TArray<struct FAttributeDefaults>                  DefaultStartingData;                                      // 0x0170(0x0010) (Edit, ZeroConstructor)
	TArray<class UAttributeSet*>                       SpawnedAttributes;                                        // 0x0180(0x0010) (ExportObject, Net, ZeroConstructor)
	unsigned char                                      UnknownData01[0x1C0];                                     // 0x0190(0x01C0) MISSED OFFSET
	float                                              OutgoingDuration;                                         // 0x0350(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              IncomingDuration;                                         // 0x0354(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x20];                                      // 0x0358(0x0020) MISSED OFFSET
	TArray<struct FString>                             ClientDebugStrings;                                       // 0x0378(0x0010) (Net, ZeroConstructor)
	TArray<struct FString>                             ServerDebugStrings;                                       // 0x0388(0x0010) (Net, ZeroConstructor)
	unsigned char                                      UnknownData03[0x58];                                      // 0x0398(0x0058) MISSED OFFSET
	bool                                               UserAbilityActivationInhibited;                           // 0x03F0(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               ReplicationProxyEnabled;                                  // 0x03F1(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bSuppressGrantAbility;                                    // 0x03F2(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bSuppressGameplayCues;                                    // 0x03F3(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x03F4(0x0004) MISSED OFFSET
	TArray<class AGameplayAbilityTargetActor*>         SpawnedTargetActors;                                      // 0x03F8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData05[0x28];                                      // 0x0408(0x0028) MISSED OFFSET
	class AActor*                                      OwnerActor;                                               // 0x0430(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	class AActor*                                      AvatarActor;                                              // 0x0438(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x10];                                      // 0x0440(0x0010) MISSED OFFSET
	struct FGameplayAbilitySpecContainer               ActivatableAbilities;                                     // 0x0450(0x00C8) (BlueprintVisible, BlueprintReadOnly, Net)
	unsigned char                                      UnknownData07[0x60];                                      // 0x0518(0x0060) MISSED OFFSET
	TArray<class UGameplayAbility*>                    AllReplicatedInstancedAbilities;                          // 0x0578(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData08[0x1D0];                                     // 0x0588(0x01D0) MISSED OFFSET
	struct FGameplayAbilityRepAnimMontage              RepAnimMontageInfo;                                       // 0x0758(0x0030) (Net)
	bool                                               bCachedIsNetSimulated;                                    // 0x0788(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPendingMontageRep;                                       // 0x0789(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x6];                                       // 0x078A(0x0006) MISSED OFFSET
	struct FGameplayAbilityLocalAnimMontage            LocalAnimMontageInfo;                                     // 0x0790(0x0030)
	unsigned char                                      UnknownData10[0xA0];                                      // 0x07C0(0x00A0) MISSED OFFSET
	struct FActiveGameplayEffectsContainer             ActiveGameplayEffects;                                    // 0x0860(0x0428) (Net)
	struct FActiveGameplayCueContainer                 ActiveGameplayCues;                                       // 0x0C88(0x00D0) (Net)
	struct FActiveGameplayCueContainer                 MinimalReplicationGameplayCues;                           // 0x0D58(0x00D0) (Net)
	unsigned char                                      UnknownData11[0x128];                                     // 0x0E28(0x0128) MISSED OFFSET
	TArray<unsigned char>                              BlockedAbilityBindings;                                   // 0x0F50(0x0010) (Net, ZeroConstructor, Transient)
	unsigned char                                      UnknownData12[0x128];                                     // 0x0F60(0x0128) MISSED OFFSET
	struct FMinimalReplicationTagCountMap              MinimalReplicationTags;                                   // 0x1088(0x0060) (Net)
	unsigned char                                      UnknownData13[0x10];                                      // 0x10E8(0x0010) MISSED OFFSET
	struct FReplicatedPredictionKeyMap                 ReplicatedPredictionKeyMap;                               // 0x10F8(0x00C0) (Net)
...
public:
	...
	struct FSoftObjectPath                             GlobalAttributeMetaDataTableName;                         // 0x0140(0x0018) (Config)
	class UDataTable*                                  GlobalAttributeMetaDataTable;                             // 0x0158(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FSoftObjectPath                             GlobalAttributeSetDefaultsTableName;                      // 0x0160(0x0018) (Config)
	...
	struct FSoftObjectPath                             GlobalGameplayCueManagerClass;                            // 0x0198(0x0018) (Config)
	struct FSoftObjectPath                             GlobalGameplayCueManagerName;                             // 0x01B0(0x0018) (Config)
	TArray<struct FString>                             GameplayCueNotifyPaths;                                   // 0x01C8(0x0010) (ZeroConstructor, Config)
	struct FSoftObjectPath                             GameplayTagResponseTableName;                             // 0x01D8(0x0018) (Config)
...
public:
	...
	float                                              AnimRootMotionTranslationScale;                           // 0x0100(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FName                                       SectionName;                                              // 0x0408(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
