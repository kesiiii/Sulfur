...
{
	static auto fn = UObject::FindObject<UFunction>("Function GA_Constructor_BullRush.GA_Constructor_BullRush_C.SetupBodytype");

	UGA_Constructor_BullRush_C_SetupBodytype_Params params;
