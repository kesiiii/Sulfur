...
{
public:
	struct FGameplayTag                                LaserTag;                                                 // 0x0A60(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
	class UAnimMontage*                                Headshot;                                                 // 0x0A68(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
