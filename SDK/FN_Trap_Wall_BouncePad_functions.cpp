...
void ATrap_Wall_BouncePad_C::ResetActivation()
{
	static auto fn = UObject::FindObject<UFunction>("Function Trap_Wall_BouncePad.Trap_Wall_BouncePad_C.ResetActivation");

	ATrap_Wall_BouncePad_C_ResetActivation_Params params;
